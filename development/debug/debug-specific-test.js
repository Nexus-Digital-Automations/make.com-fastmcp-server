...
async function runTest() {
  try {
    ...
    const { addBudgetControlTools } = await import(
      "./dist/tools/budget-control.js"
    );
    ...
    if (tool) {
      ...
      console.log(
        ...
        parsedResult.recommendations !== undefined,
      );
      console.log(
        "controlActions defined:",
        parsedResult.controlActions !== undefined,
      );
    }
  } catch (error) {
